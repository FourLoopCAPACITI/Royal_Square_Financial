  ...
  return (
    <div className="mb-6 flex gap-3 rounded-md border border-warn bg-warn-tint p-4" role="status">
      ...
      <div>
        ...
        <p className="text-[14.5px]">Your accident information will be saved securely on this device and synced when connectivity returns.</p>
      </div>
    </div>
  );
}
    ...
    <div className="mx-auto max-w-5xl">
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[14px] text-brand-grey">Step {index + 1} of {ACCIDENT_STEPS.length}. Your progress is saved automatically.</p>
        </div>
        <button type="button" onClick={cancel} className="text-[14px] font-semibold text-brand-grey hover:text-brand-black">Cancel</button>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_280px]">
        ...
        <aside className="space-y-4">
          ...
          <ol className="hidden space-y-1 text-[14px] lg:block" aria-label="Steps">
