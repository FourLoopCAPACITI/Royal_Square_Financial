  ...
  return (
    <div className="min-h-screen bg-brand-light-grey text-brand-black">
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <header className="border-b border-brand-border bg-surface px-4 py-3 sm:px-6">
        ...
        <main className="mt-8">
          <section className="overflow-hidden rounded-[28px] border border-brand-border bg-surface shadow-sm">
            <div className="grid items-center gap-8 px-6 py-8 md:grid-cols-[1.2fr_0.8fr] md:px-10 md:py-12">
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-[28px] border border-brand-border bg-gradient-to-br from-brand-red-tint via-surface to-brand-light-grey p-6 shadow-inner">
          ...
          {demoModeEnabled && (
            <section className="mt-8 rounded-2xl border border-brand-border bg-surface p-6">
                ...
                <div className="flex transition-opacity duration-300">
                  {orderedPartners.map(({ name, className }) => (
                    <div key={name} className="flex min-w-full items-center justify-center px-3 sm:min-w-[33.333%] lg:min-w-[14.285%]">
                      <span className={`whitespace-nowrap text-2xl dark:!text-brand-black sm:text-3xl ${className}`}>{name}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <footer id="contact" className="mt-14 scroll-mt-6 rounded-t-[28px] border-t border-brand-border bg-[#0c0c0c] px-6 py-8 text-white sm:px-8">
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              <div className="inline-block overflow-hidden rounded-xl bg-surface p-3 shadow-sm">
