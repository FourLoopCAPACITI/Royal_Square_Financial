  ...
  return (
    <>
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_300px]">
        <div>
          <Section title="Action required" count={tasks.data?.length} action={<Link to="/client/actions" className="text-[15.5px] font-semibold text-brand-red hover:underline">All actions</Link>}>
        ...
        <aside className="space-y-6">
          ...
          <div>
            <div className="mb-3 flex items-baseline justify-between">
              ...
              <Link to="/client/goals" className="text-[15.5px] font-semibold text-brand-red hover:underline">View goals</Link>
            </div>
