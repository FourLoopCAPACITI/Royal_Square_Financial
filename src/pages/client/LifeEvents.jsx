    ...
    <>
        ...
        {LIFE_EVENTS.map((ev) => (
          ...
          >
            ...
            <span>
              ...
              <span className="block text-[15px] text-brand-grey">{ev.description}</span>
            </span>
          </button>
        ))}
      </div>
      ...
      {selected && selected !== 'moved' && (
        <div className="mt-6 max-w-xl rounded-md border border-dashed border-brand-border p-5">
          ...
          <p className="text-[16px] text-brand-grey">This life event will use the same workflow engine. For now, message your adviser or start a consultation request.</p>
      ...
      {outcome && (
        <div className="mt-6 rounded-md border border-brand-border p-5 sm:p-6" role="status">
          <p className="text-[15.5px] text-ok">Change of address workflow created</p>
