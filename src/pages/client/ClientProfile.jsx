          ...
          c && (
            <>
              <Section title="Personal details">
                ...
                <p className="mt-2 text-[14.5px] text-brand-grey">To change your address or bank details, use Life Events or Requests so every provider is updated.</p>
              </Section>
                      ...
                      {list.map((p) => (
                        <li key={p.id} className="flex flex-wrap justify-between gap-2 p-4">
                          <span>
                            ...
                            <span className="text-[15.5px] text-brand-grey">{providerName(p.providerId)}. {p.description}</span>
                          </span>
