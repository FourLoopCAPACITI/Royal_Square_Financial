    ...
    <div className="rounded-md border border-brand-border p-5">
      ...
      {claim.evidence?.length > 0 && (
        <div className="mt-4 border-t border-brand-border pt-4">
          <p className="mb-2 text-[15.5px] font-semibold">Evidence {captured} / {claim.evidence.length}</p>
      ...
      {claim.capturedOffline && <p className="mt-3 text-[14.5px] text-brand-grey">Captured offline and synced when the phone reconnected.</p>}
    </div>
  );
}
