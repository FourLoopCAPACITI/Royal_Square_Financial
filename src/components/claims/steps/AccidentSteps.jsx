  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {recording && <span className="flex items-center gap-2 text-[14px] text-brand-red"><span className="rsf-ball h-2.5 w-2.5 rounded-full bg-brand-red" aria-hidden="true" />{t('accident.desc.recording')}</span>}
