  ...
  return (
    <div className="fixed bottom-20 right-4 z-40 lg:bottom-6 lg:right-6">
        ...
        >
          <div className="flex items-center justify-between border-b border-brand-border px-4 py-3">
            <div>
              ...
              <p className="text-[14px] text-brand-grey">Help with services and statuses</p>
            </div>
      ...
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="ml-auto flex items-center gap-2 rounded-full border border-brand-border bg-white px-4 py-3 text-[15.5px] font-semibold shadow-[0_4px_14px_rgba(10,10,10,0.10)] hover:border-brand-red"
        aria-expanded={open}
      >
