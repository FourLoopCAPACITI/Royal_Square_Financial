...
export default function NetWorthSummary({ assets = 0, liabilities = 0 }) {
  ...
  return (
    <div className="rounded-md border border-brand-border p-5">
      <p className="text-[14.5px] text-brand-grey">Estimated net worth</p>
      ...
      <p className="mt-3 text-[14px] text-brand-grey">Based on information you've shared with your adviser.</p>
    </div>
  );
}
